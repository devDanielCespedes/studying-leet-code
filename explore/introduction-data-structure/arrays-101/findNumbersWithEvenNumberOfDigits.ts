...
// run `npx ts-node explore/introduction-data-structure/arrays-101/findNumbersWithEvenNumberOfDigits.ts` 
...
console.log(findNumbersWithEvenDigits([555, 901, 482, 1771]))
